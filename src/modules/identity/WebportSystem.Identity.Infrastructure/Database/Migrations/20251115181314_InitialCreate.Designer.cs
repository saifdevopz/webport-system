...
namespace WebportSystem.Identity.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251115181314_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.Role", b =>
                {
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.UserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.UserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.RoleClaim", b =>
                {
                    b.HasOne("WebportSystem.Identity.Domain.Users.Role", null)
                        .WithMany()
                    ...
                    b.HasOne("WebportSystem.Identity.Domain.Users.Role", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("WebportSystem.Identity.Domain.Users.UserClaim", b =>
                {
                    b.HasOne("WebportSystem.Identity.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.HasOne("WebportSystem.Identity.Domain.Users.User", "User")
                        .WithMany("Claims")
